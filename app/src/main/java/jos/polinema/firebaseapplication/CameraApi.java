...
public class CameraApi extends AppCompatActivity {
    //metod request ke kamera dan penyimpanaan
    private static final int REQUEST_CAMERA = 1;
    private static final int REQUEST_STORAGE = 1;
    //metod untuk authen author profider
    private static final String FILE_PROVIDER_AUTHORITY = "jos.polinema.contenprovider";
    ...
    //method untuk permission ke storage
    public void emojify()
    {
    ...
    private void processAndSetImage() {
        ...
        // menampilkan foto ke image view
